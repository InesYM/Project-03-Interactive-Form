...
$(document).ready(function () {                  
  ...
  const showInputValidationError = (queryString, errIDName, displayText, paddingBottom) =>
  {
      ...
      let errMesgEle = $('<div id="' + errIDName + '" style="color: red; font-weight: bold; padding-bottom:' + paddingBottom + 'px;"></div>').text(displayText);
  ...
  if (validationAllPageFormElements())
  {
    ...
    let successMesgEle = $('<div id="success" style="color: green; font-weight: bold; padding-bottom:' + 0 + 'px;"></div>').text("Submit would be executed now.");
